...
import { bootstrapSchema, loginSchema } from './schemas.js'
import { bootstrap, login, logout, refresh, registerTenant } from './service.js'
import { authenticate } from './middleware.js'
import { listMemberships } from './repository.js'

const cookieOptions = () => ({ httpOnly: true, secure: config.COOKIE_SECURE, sameSite: 'strict', path: '/api/auth', maxAge: config.REFRESH_TOKEN_DAYS * 86_400 })
